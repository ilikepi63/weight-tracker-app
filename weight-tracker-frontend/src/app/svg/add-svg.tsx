...
export default function CloseSvg() {
	return (<svg height="16px" width="16px" version="1.1" id="Capa_1"
		...
		<g>
           ...
           c15.632,0,28.348-12.717,28.348-28.338C309.059,138.903,296.342,126.181,280.71,126.181z" fill="black" />
			</g>
		</g>
	</svg>);
}
